...
export const metadata = {
  ...
  description:
    "Exploring the tumultuous relationship between the Roman co-emperors Caracalla and Geta, whose rivalry ultimately led to fratricide and changed the course of Roman history.",
  date: "2024-12-21",
  author: "Coin Cabinet",
  slug: "caracalla-and-geta",
  image:
    "https://res.cloudinary.com/coin-cabinet/image/upload/v1640995200/blog/caracalla-geta-coins-header.jpg",
  imageAlt:
    "Ancient Roman coins featuring portraits of emperors Caracalla and Geta from the Severan dynasty",
  keywords: [
    "Caracalla",
    "Geta",
    "Roman Empire",
...
export default function CaracallaAndGetaArticle() {
  return (
    <article className="prose prose-lg prose-slate prose-invert max-w-none">
      ...
      <Lead>
        The story of Caracalla and Geta represents one of the most dramatic
        episodes in Roman imperial history. Born to Emperor Septimius Severus
        and Julia Domna, these two brothers were destined for greatness but
        ultimately became bitter rivals whose conflict would tear apart the
        Severan dynasty.
      </Lead>
      ...
      <p>
        The assassination of Geta by his brother Caracalla in 211 CE marked a
        turning point in Roman history. This fratricide not only ended the joint
        rule but also initiated a period of increasingly autocratic imperial
        governance that would characterize the later Roman Empire.
      </p>
      ...
      <p>
        Excepteur sint occaecat cupidatat non proident, sunt in culpa qui
        officia deserunt mollit anim id est laborum. The coins minted during
        their joint rule and the subsequent damnatio memoriae of Geta provide
        fascinating insights into the political propaganda of the time.
      </p>

        ...
        <div className="mx-auto max-w-4xl">
          ...
          <div className="artemis-card p-8">
            ...
            <p className="coin-description text-lg leading-relaxed">
              This page will showcase coins from the Roman Imperatorial period
              (49-27 BC). Coming soon with detailed information and high-quality
              images of coins issued by Julius Caesar, Mark Antony, and other
              military commanders.
            </p>
          </div>
        </div>
